...
def rdf_column_names(rdf: Any) -> set:
    """
    Returns the set of column names of a root DataFrame. Columns coming from friend trees are
    additionally reported without their '<tree>.' prefix.
